  ...
  return (
    <section className="vacancy">
      <article className="vacancy-short-info">
        <h3 className="vacancy-title">Maneger</h3>
        <section className="vacancy-offers">
          <span className="vacancy-salary">40 000</span>
          {'*'}
          <span className="vacancy-working-mode">Full day</span>
        </section>
